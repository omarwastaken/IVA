...
class ChatInterface:
    ...
    def add_message_bubble(self, message, is_user=True):
        ...
        # Calculate y_position based on whether it's the first message or not
        if not self.chat_bubbles:  # If this is the first bubble
            y_position = self.START_MARGIN
        else:
            # Get the y_position of the last bubble and add spacing
        ...
        # Create the bubble and label, then append to the list and update view
