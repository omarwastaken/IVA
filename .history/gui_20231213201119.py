...
class ChatInterface:
    ...
    def process_and_display_response(self, message):
        ...
        self.manage_typing_animation("show")
    ...
    def add_ai_message(self, message):
        ...
        # If the typing bubble exists, update it with the AI's message
        if self.typing_bubble_id is not None:
            self.update_message_bubble(self.typing_bubble_id, message)
        # If the typing bubble does not exist, create a new bubble for the AI's message
        else:
