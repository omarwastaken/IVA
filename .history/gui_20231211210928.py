...
class ChatInterface:
    ...
    def add_message_bubble(self, message, is_user=True):
        ...
        y_position = self.START_MARGIN + self.total_bubble_height + len(self.chat_bubbles) * self.BUBBLE_SPACING
        ...
        self.total_bubble_height += label_height
