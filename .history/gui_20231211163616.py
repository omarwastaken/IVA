...
class ChatInterface:
    ...
    def hide_typing_animation(self):
        ...
        if self.typing_animation_id is not None:
            ...
            self.typing_animation_id = None
        if self.typing_bubble_id is not None and 0 <= self.typing_bubble_id < len(self.chat_bubbles):
            bubble, message_label_window = self.chat_bubbles[self.typing_bubble_id]
