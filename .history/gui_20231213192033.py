...
class ChatInterface:
    ...
    def __init__(self, root):
        ...
        self.root = root
        self.chat_bubbles = {}  # Change to a dictionary to track bubble labels
    ...
    def add_message_bubble(self, message, is_user=True):
        ...
        self.chat_canvas.create_window((self.CHAT_AREA_WIDTH / 2, self.bubble_margin_top), window=bubble_frame, anchor="w" if is_user else "e", width=self.TEXT_WIDTH_LIMIT)
