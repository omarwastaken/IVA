...
class ChatInterface:
 ...
 # ======================== Focus Mode Feature ========================            
    ...
    def setup_focus_mode_components(self):
        ...
        self.adjustment_button_frame = tk.Frame(self.focus_mode_frame, bg="#c19b59")
        self.adjustment_button_frame.pack(pady=(0, 100))  # Reduced top padding, added a little bottom padding
