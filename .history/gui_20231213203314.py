...
class ChatInterface:
    ...
    def add_message_bubble(self, message, is_user=True):
        ...
        bubble_id = self.chat_canvas.create_window((self.CHAT_AREA_WIDTH / 2, self.bubble_margin_top), window=bubble_frame, anchor="nw" if is_user else "ne", width=self.TEXT_WIDTH_LIMIT)
