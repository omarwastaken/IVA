 ...
 # ======================== Focus Mode Feature ========================            
    ...
    def update_timer(self):
        if self.current_time > 0:
            ...
            angle = (1 - self.current_time / self.POMODORO_TIME) * 360
            self.timer_canvas.delete(self.circle)
            self.circle = self.timer_canvas.create_arc(20, 20, 180, 180, start=-90, extent=angle, outline=self.FONT_COLOR, width=2, style=tk.ARC)
