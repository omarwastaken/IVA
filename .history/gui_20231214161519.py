...
class ChatInterface:
    ...
    def setup_ui(self):
        ...
        self.chat_frame.grid_rowconfigure(0, weight=1)  # Make the top frame resizable
        ...
        self.bottom_frame.grid_columnconfigure(0, weight=1)  # Make the input field resizable
