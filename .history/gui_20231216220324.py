            ...
            if reminders:
                for reminder in reminders:
                    ...
                    if 'dateTime' in start:
                        ...
                        start_date = datetime.datetime.fromisoformat(start['date/Time']).date()
                        end_date = datetime.datetime.fromisoformat(end['date/Time']).date() - datetime.timedelta(days=1)  # Adjust for Google's end date representation
