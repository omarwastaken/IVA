...
class ChatInterface:
    ...
    def process_and_display_response(self, message):
        ...
        # Replace the typing animation with AI's response
        self.root.after(0, lambda: self.update_message_bubble(self.typing_bubble_id, response) if response else self.hide_typing_animation())
