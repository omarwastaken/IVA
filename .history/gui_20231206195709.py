...
BUBBLE_COLOR = "#f0f0f0"       # Light grey for bubbles
BACKGROUND_COLOR = '#202225'   # Dark grey for background
FONT_COLOR = '#ffffff'         # White for font
SEND_BUTTON_COLOR = "#5865F2"  # Discord-like blue for buttons
...
# Create a text field
# Updated text field style
text_field = tk.Entry(bottom_frame, width=40, font=customFont, fg=FONT_COLOR, bg="#40444B", borderwidth=2)
text_field.pack(side=tk.LEFT, padx=10, pady=5)
text_field.insert(0, "Type your message...")  # Placeholder text
