...
class ChatInterface:
    ...
    def add_ai_message(self, message):
        ...
        # If a typing animation is active, update the bubble instead of adding a new one
        if self.is_typing_animation_active and self.typing_bubble_id is not None:
            ...
            # Now that we've updated the typing bubble with the response, reset the typing bubble ID
            self.typing_bubble_id = None
        else:
            # No typing animation was active, so we just add a new bubble as usual
