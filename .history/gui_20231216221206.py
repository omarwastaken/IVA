        ...
        try:
            ...
            if reminders:
                for reminder in reminders:
                    ...
                    time_str = reminder['time']  # Use the formatted time
                    display_text = f"{summary} | {time_str}"
                    self.todo_list_tree.insert('', tk.END, text='✓', values=(display_text,), iid=reminder['id'])
            else:
