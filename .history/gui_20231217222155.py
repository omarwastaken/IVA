...
class ChatInterface:
 ...
 # ======================== Focus Mode Feature ========================            
    ...
    if self.current_time > 0:
        ...
        # Calculate the remaining extent of the arc
        remaining_extent = (self.current_time / self.POMODORO_TIME) * 360

        # Update the circle timer
        self.timer_canvas.delete("timer_arc")  # Delete the old arc
        # Draw a new arc representing the remaining time
        self.timer_canvas.create_arc(20, 20, 180, 180, start=90, extent=-remaining_extent, outline=self.FONT_COLOR, width=2, style=tk.ARC, tags="timer_arc")
