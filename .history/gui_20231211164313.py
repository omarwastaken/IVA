...
class ChatInterface:
    ...
    def hide_typing_animation(self):
        ...
        # If we hide the typing animation without a response (e.g., an error occurred), we remove the bubble
        if self.typing_bubble_id is not None:
            # Only remove the bubble if a response hasn't already updated it
