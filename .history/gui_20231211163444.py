...
class ChatInterface:
    ...
    def process_and_display_response(self, message):
        ...
        self.show_typing_animation()  # Start typing animation
        response = process_input(message, self.previous_questions_and_answers)  # This is a blocking call
        # Replace the typing message with the actual response in the same bubble
        self.root.after(0, lambda: self.update_typing_bubble_with_response(response))
