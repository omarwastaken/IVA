...
class ChatInterface:
    ...
    def setup_reminders_components(self):
        ...
        self.refresh_button = tk.Button(self.todo_list_label_frame, text="Refresh", command=self.refresh_on_thread, bg=self.TODO_LIST_LABEL_BG, fg=self.TODO_LIST_LABEL_FG)
