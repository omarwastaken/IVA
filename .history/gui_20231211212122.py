...
class ChatInterface:
    ...
    def add_message_bubble(self, message, is_user=True):
        ...
        # Increase y_position by self.BUBBLE_SPACING to add space above the first bubble
        y_position = self.next_bubble_y_position if self.chat_bubbles else self.START_MARGIN + self.BUBBLE_SPACING
        ...
        # Update next_bubble_y_position to ensure consistent spacing
        self.next_bubble_y_position = y_position + label_height + self.BUBBLE_SPACING
