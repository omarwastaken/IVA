...
class ChatInterface:
    ...
    def setup_reminders_components(self):
        ...
        self.todo_list_tree = ttk.Treeview(self.features_frame, columns=('Reminder', 'Date'), style="Treeview", xscrollcommand=None)
        ...
        self.todo_list_tree.column('#0', width=50, anchor='center', stretch=False)
        self.todo_list_tree.column('Reminder', width=250, stretch=False)
        self.todo_list_tree.column('Date', width=150, anchor='center', stretch=False)
        ...
        # Vertical Scrollbar (already present)
        scrollbar = ttk.Scrollbar(self.features_frame, orient="vertical", command=self.todo_list_tree.yview)
        scrollbar.pack(side=tk.RIGHT, fill=tk.Y)
        self.todo_list_tree.configure(yscrollcommand=scrollbar.set)

        # Horizontal Scrollbar (add this if needed)
        xscrollbar = ttk.Scrollbar(self.features_frame, orient="horizontal", command=self.todo_list_tree.xview)
        xscrollbar.pack(side=tk.BOTTOM, fill=tk.X)
        self.todo_list_tree.configure(xscrollcommand=xscrollbar.set)
