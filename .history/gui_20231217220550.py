...
class ChatInterface:
 ...
 # ======================== Focus Mode Feature ========================            
    ...
    def update_timer(self):
        if self.current_time > 0:
            ...
            # Calculate elapsed time as a fraction of POMODORO_TIME
            elapsed_fraction = (self.POMODORO_TIME - self.current_time) / self.POMODORO_TIME
            extent = elapsed_fraction * 360
            # Draw the arc representing the elapsed time
 ...
 # ======================== Focus Mode Feature Event Handling ========================            
    ...
    # Ensure that the timer is properly initialized
    if not self.is_timer_running:
        self.current_time = self.POMODORO_TIME  # Reset to full duration
