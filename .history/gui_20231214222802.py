...
class ChatInterface:
    ...
    def setup_feature_components(self):
        ...
        self.todo_list_tree = ttk.Treeview(self.features_frame, columns=('Reminder', 'Date'))
        self.todo_list_tree.heading('#0', text='Done')
        self.todo_list_tree.heading('Reminder', text='Reminder')
        self.todo_list_tree.heading('Date', text='Date')
        self.todo_list_tree.column('#0', width=50)
        self.todo_list_tree.column('Reminder', width=250)
        self.todo_list_tree.column('Date', width=150)
        ...
        self.todo_list_tree.bind('<Double-1>', self.mark_done)  # Bind double click to mark_done function

        self.display_reminders()

    def mark_done(self, event):
        selected_item = self.todo_list_tree.selection()[0]  # Get selected item ID
        mark_reminder_as_done(selected_item)  # Call the backend function
        self.todo_list_tree.delete(selected_item)  # Remove the item from the list
