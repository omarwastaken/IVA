...
class ChatInterface:
    ...
    def __init__(self, root):
        ...
        self.last_bubble_end_y = self.START_MARGIN
    ...
    def add_message_bubble(self, message, is_user=True):
        ...
        if not self.chat_bubbles:
            ...
            y_position = self.last_bubble_y_position + self.BUBBLE_SPACING + self.PADDING * 2
        ...
        if is_user or (not is_user and self.typing_animation_id is None):
            self.last_bubble_end_y = y_position + label_height
        return bubble_id
    ...
    def calculate_y_position(self):
        ...
        if not self.chat_bubbles:
            ...
            return self.last_bubble_end_y + self.BUBBLE_SPACING
