...
class ChatInterface:
    ...
    def handle_voice_input(self):
        """Handle voice input when the microphone button is pressed."""
        voice_input = recognize_speech()  # Assuming recognize_speech is imported
        if voice_input:
            self.add_message_bubble(voice_input, is_user=True)
