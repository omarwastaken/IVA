...
def add_message_bubble(canvas, message, customFont):
    if not chat_bubbles:
        first_bubble_additional_offset = 20  # Increase this value for more space
    else:
        first_bubble_additional_offset = 0

    y_position = ((BUBBLE_SPACING + PADDING * 4) * len(chat_bubbles)) + first_bubble_additional_offset
