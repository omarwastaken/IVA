...
def add_message_bubble(canvas, message, customFont):
    # Adjust y_position to include initial top margin for the first bubble
    y_position = INITIAL_TOP_MARGIN + (BUBBLE_SPACING + PADDING * 2) * len(chat_bubbles)
