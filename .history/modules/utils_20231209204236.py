...
def recognize_speech():
    ...
    with sr.Microphone() as source:
        print("Speak now...")
        audio = r.listen(source, phrase_time_limit=5)  # Limit listening time to allow for periodic checks
    try:
    ...
    if switcher.check_mode_switched():
        return "MODE_SWITCH"  # Special value indicating a mode switch request
    return None
