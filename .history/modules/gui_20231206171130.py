...
def send_message():
    ...
    if message:
        ...
        y_position = initial_offset + (bubble_spacing + padding * 2) * len(chat_bubbles)
        ...
        # Additional line to update the scrollregion after adding a new bubble
...
# Canvas for chat bubbles, with an explicit height set
