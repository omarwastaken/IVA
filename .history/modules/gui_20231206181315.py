...
def add_message_bubble(canvas, message, customFont):
    # Apply an additional offset for the first bubble
    first_bubble_offset = INITIAL_OFFSET if len(chat_bubbles) == 0 else 0
    y_position = (BUBBLE_SPACING + PADDING * 2) * len(chat_bubbles) + first_bubble_offset
