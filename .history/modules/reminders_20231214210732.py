...
def get_reminders_for_period(period):
    ...
    # If you want to filter these events further (e.g., by a keyword), modify the following line
    filtered_events = [event for event in events if 'reminder' in event.get('description', '')]
