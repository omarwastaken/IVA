...
ai_image = ai_image.resize((50, 50), Image.ANTIALIAS)

user_avatar = Label(chat_frame, image=ImageTk.PhotoImage(user_image), bg="#eeeeee")
user_avatar.pack(side="left", padx=10, pady=10)

ai_avatar = Label(chat_frame, image=ImageTk.PhotoImage(ai_image), bg="#eeeeee")
