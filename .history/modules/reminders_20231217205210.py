...
def create_reminder(user_input):
  ...
  if reminder_content and time_str:
    try:
      ...
      # Added confirmation message based on saved reminder details
      if is_recurring:
        confirmation = f"Okay, I'll remind you every day at {formatted_time} to {reminder_content}."
      else:
        confirmation = f"Okay, I'll remind you on {formatted_date} at {formatted_time} to {reminder_content}."
      response_messages.append(confirmation)
    except ValueError:
