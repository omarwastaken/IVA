...
class ChatApp:
    ...
    def display_message(self, msg, side):
        label = tk.Label(self.frame, text=msg, bg="#e0e0e0", wraplength=250, anchor='w', justify=tk.LEFT)
        label.pack(pady=5, padx=(100 if side == "right" else 10, 10 if side == "right" else 100), anchor=('e' if side == "right" else 'w'))
