...
class ChatInterface:
    ...
    def setup_ui(self):
        ...
        self.paned_window.add(self.chat_frame, weight=1)  # Adjust weight as needed
        self.chat_frame.grid_rowconfigure(0, weight=1)
        self.chat_frame.grid_columnconfigure(0, weight=1)

        # Additional Features Frame
        self.features_frame = tk.Frame(self.paned_window, bg=self.BACKGROUND_COLOR)
        self.paned_window.add(self.features_frame, weight=1)  # Adjust weight as needed
    ...
    def setup_chat_components(self):
        ...
        self.top_frame.grid(row=0, column=0, sticky="nsew", padx=500, pady=5)
