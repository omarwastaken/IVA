...
class ChatInterface:
    ...
    def setup_ui(self):
        ...
        self.paned_window.add(self.chat_frame, stretch="always")  # Allow chat frame to stretch
        ...
        self.paned_window.add(self.features_frame, stretch="never")  # Prevent features_frame from stretching
    ...
    def setup_reminders_components(self):
        ...
        # Set up the Treeview without a horizontal scrollbar
