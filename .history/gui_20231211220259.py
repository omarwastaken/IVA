...
class ChatInterface:
    ...
    def add_message_bubble(self, message, is_user=True):
        ...
        # Adjust y_position for the first message or subsequent messages
        y_position = self.bubble_margin_top if not self.chat_bubbles else self.chat_bubbles[-1][1] + self.BUBBLE_SPACING
        ...
        self.chat_bubbles.append((y_position + label_height, message_label_window))
