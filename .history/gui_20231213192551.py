...
class ChatInterface:
    ...
    def add_ai_message(self, message):
        ...
        if self.is_typing_animation_active and self.typing_bubble_id is not None:
            self.delete_message_bubble(self.typing_bubble_id)
            self.typing_bubble_id = None
            self.is_typing_animation_active = False
    ...
    def add_message_bubble(self, message, is_user=True):
        ...
        # [Existing logic to create the bubble_frame and message_label]
        ...
        self.chat_bubbles[bubble_id] = bubble_frame  # Store the bubble frame with its ID
        self.refresh_chat_view()
        return bubble_id

    def delete_message_bubble(self, bubble_id):
        """Delete an existing message bubble."""
        if bubble_id in self.chat_bubbles:
            bubble_frame = self.chat_bubbles[bubble_id]
            self.chat_canvas.delete(bubble_frame)
            del self.chat_bubbles[bubble_id]
