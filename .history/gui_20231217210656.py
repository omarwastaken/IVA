...
# Theme Constants for a Pretty AI Assistant App

BACKGROUND_COLOR = {
    "top": "#202225",
    "bottom": "#272a2e",
}  # Subtle gradient for depth and dynamism

FONT_COLOR = "#f2f2f2"  # High contrast white for readability

SEND_BUTTON_COLOR = {
    "top": "#4169E1",
    "bottom": "#458DF6",
}  # Gradient for vibrant hover effect

PLACEHOLDER_COLOR = "#d0d0d0"  # Improved legibility for inactive text

TODO_LIST_LABEL_BG = "#f0f0f0"  # Consistent with light theme option

TODO_LIST_LABEL_FG = "#333"  # Consistent with light theme option

TREEVIEW_HEADING_FONT_COLOR = "blue"  # Maintain original value

FONT_FAMILY = "Helvetica"  # Maintain original value

FONT_SIZE = 12  # Maintain original value

LINE_SPACING = 12  # Maintain original value

TODO_LIST_LABEL_FONT = ("Arial", 12, "bold")  # Maintain original value

TREEVIEW_HEADING_FONT = ("Calibri", 11, "bold")  # Maintain original value

TREEVIEW_FONT = ("Arial", 10)  # Maintain original value

# Additional options for theme personalization
LIGHT_THEME_BACKGROUND = "#f0f0f0"
LIGHT_THEME_FONT_COLOR = "#333"

# ... Implement theme switching functionality, color palette selection, etc.
