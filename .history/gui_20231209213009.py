...
class ChatInterface:
    ...
    def __init__(self, root):
        ...
        self.root = root
        self.chat_bubbles = []
        self.previous_questions_and_answers = []  # Keep track of the conversation
        try:
            self.setup_ui()
    ...
    def animate_typing(self):
        ...
        if hasattr(self, 'typing_message'):
            ...
            self.root.after(500, self.animate_typing)  # Update every 500ms
    ...
    def hide_typing_animation(self):
        ...
        if hasattr(self, 'typing_bubble_id'):
            ...
            del self.typing_message
            del self.typing_bubble_id
    ...
    def process_and_display_response(self, message):
        ...
        self.show_typing_animation()  # Show typing animation
        response = process_input(message, self.previous_questions_and_answers)
        self.root.after(0, self.hide_typing_animation)  # Hide typing animation
        if response:
