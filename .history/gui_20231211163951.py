...
class ChatInterface:
    ...
    def add_ai_message(self, message):
        """Add a message from the AI to the chat interface, replacing the typing animation if active."""
        if self.typing_animation_id is not None and self.typing_bubble_id is not None:
            # If the typing animation is active, replace the message in the typing bubble
            self.update_message_bubble(self.typing_bubble_id, message)
            # Stop the typing animation
            self.hide_typing_animation()
        else:
            # If no typing animation, just add a new message bubble
