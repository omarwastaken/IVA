...
class ChatInterface:
 ...
 # ======================== Focus Mode Feature ========================            
    ...
    def setup_focus_mode_components(self):
        ...
        self.circle = self.timer_canvas.create_oval(20, 20, 100, 100, outline=self.FONT_COLOR, width=3)
    ...
    def update_timer(self):
        if self.current_time > 0:
            ...
            self.circle = self.timer_canvas.create_arc(10, 10, 90, 90, start=-90, extent=angle, outline=self.FONT_COLOR, width=2, style=tk.ARC)
