...
class ChatInterface:
 ...
 # ======================== Focus Mode Feature ========================            
    ...
    def display_quote(self):
        ...
        quote_label = tk.Label(self.focus_mode_frame, text=quote, wraplength=200, justify="center", bg=self.BACKGROUND_COLOR, fg=self.FONT_COLOR)
        quote_label.pack()   
