...
class ChatInterface:
    ...
    def calculate_bubble_position(self, label_width, is_user):
        AI_LABEL_OFFSET = 100  # Increase this as needed for AI message bubbles
        if is_user:
            ...
            bubble_x1 = AI_LABEL_OFFSET
            bubble_x2 = label_width + AI_LABEL_OFFSET
            window_x = self.WINDOW_OFFSET + AI_LABEL_OFFSET
