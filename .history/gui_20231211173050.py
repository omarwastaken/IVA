...
class ChatInterface:
    ...
    def add_message_bubble(self, message, is_user=True):
        ...
        # No need to recalculate y_position based on the number of bubbles for every message
        # Instead, we keep track of the y_position with self.last_bubble_y_position
        ...
        # Update the y_position for the next bubble
        self.last_bubble_y_position = y_position + label_height + self.BUBBLE_SPACING
        self.refresh_chat_view()  # Refresh the chat view every time a new message is added
