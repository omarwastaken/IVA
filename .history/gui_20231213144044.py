...
class ChatInterface:
    ...
    """Toggle the input state between text and voice."""
    from utils import INPUT_MODE  # Import the variable

    # Toggle INPUT_MODE between 1 and 2
    INPUT_MODE = 2 if INPUT_MODE == 1 else 1

    # Update GUI components based on the mode
    state = tk.DISABLED if INPUT_MODE == 2 else tk.NORMAL
