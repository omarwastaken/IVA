 ...
 # ======================== Focus Mode Feature ========================            
    ...
    def update_timer(self):
        if self.current_time > 0:
            ...
            threading.Thread(target=lambda: self.play_sound('assets/End_Focus_Mode.mp3'), daemon=True).start()  # Play end sound in a non-blocking way
 ...
 # ======================== Focus Mode Feature Event Handling ========================            
    ...
    def start_focus_timer(self):
        ...
        if not self.is_timer_running:
                ...
                threading.Thread(target=lambda: self.play_sound('assets/Start_Focus_Mode.mp3'), daemon=True).start()  # Play start sound in a non-blocking way
                self.update_timer()
